...
CREATE TABLE `LeaveEntitlement` (
  ...
  PRIMARY KEY (`id`),
  KEY `LeaveEntitlement_employeeId_fkey` (`employeeId`),
  CONSTRAINT `LeaveEntitlement_employeeId_fkey` FOREIGN KEY (`employeeId`) REFERENCES `Employee` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2024-02-19  0:15:51
