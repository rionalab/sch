...
export type MenuAccess =
  ...
  | "role_hr_student_registration"
  | "role_hr_student_registration_view"
  | "role_hr_student_registration_edit"
  | "role_hr_student_registration_create"
  | "role_hr_student_registration_delete"
  | "role_admin"
  | "role_admin_role"
